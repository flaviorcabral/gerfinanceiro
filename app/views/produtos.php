                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-warning btn-lg btn-block"><i
                                                        class="fa fa-wrench"></i> Produtos/Estoque
                            </button>
                        </div>

                        <div class="ibox-content">
                            <div class="pull-left">
                                <a onclick="#" href="produtosacoes.php?acao=novo" class="btn btn-warning ">Incluir</a>
                            </div>
                            <br>
                            <br>
                            <br>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($produtos)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php $coluna1 = $produtos[$f]["cdprod"]; ?>
                                                <?php $coluna2 = $produtos[$f]["deprod"]; ?>
                                                <?php $coluna3 = $produtos[$f]["vlprod"]; ?>
                                                <?php $coluna4 = $produtos[$f]["qtprod"]; ?>

                                                <?php $ver = "produtosacoes.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $edita = "produtosacoes.php?acao=edita&chave=".$coluna1; ?>
                                                <?php $apaga = "produtosacoes.php?acao=apaga&chave=".$coluna1; ?>
    ...
    <script>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv', title: 'Gerenciador Financeiro'},
