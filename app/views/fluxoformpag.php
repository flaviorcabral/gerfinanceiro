<?php
    ...
    $vendas = $con->buscaContasPorFormaPag();
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <button type="button" class="btn btn-warning btn-lg btn-block"><i
                                                    class="fa fa-calculator"></i> Contas a Receber Vendas - Forma de Pagamento
                        </button>
                    </div>
                    <br>
                    <div>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                <tbody>
                                    <?php for ($f =0; $f <= (count($vendas)-1); $f++) { ?>
                                        <tr class="gradeX">
                                            <?php $datap = strtotime($vendas[$f]["dtcont"]) ;?>

                                            <?php $coluna1 = date("d/m/Y",$datap); ?>
                                            <?php $coluna2 = trim($vendas[$f]["cdform"]); ?>
                                            <?php $coluna3 = number_format($vendas[$f]["vlcont"],2,",","."); ?>
                                            <?php $coluna4 = trim($vendas[$f]["cdclie"]); ?>
                                            <?php $coluna5 = trim($vendas[$f]["cdvenda"]); ?>
