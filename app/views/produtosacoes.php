...
<head>
    ...
    <title>Gerenciado Financeiro | Principal </title>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-warning btn-lg btn-block"><i
                                                        class="fa fa-wrench"></i> Produtos - <small><?php echo $titulo; ?></small>
                            </button>
                        </div>
                                ...
                                <br>
                                    <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input id="cdpeca" name="cdpeca" value="<?php echo $produto["cdprod"]; ?>" type="text" placeholder="" class="form-control" autofocus maxlength = "50" <?php if($acao == 'ver' or $acao == 'apaga'): ?>readonly=""<?php endif; ?> required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="depeca" name="depeca" value="<?php echo $produto["deprod"]; ?>" type="text" placeholder="" class="form-control" maxlength = "100" <?php if($acao == 'ver' or $acao == 'apaga'): ?>readonly=""<?php endif; ?> required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <?php if($produto["vlprod"]){ $valor = $con->exibeValorProduto($produto["vlprod"]); }else{ $valor = ''; }?>
                                                    <input id="vlpeca" name="vlpeca" value="<?php echo $valor; ?>" type="text" placeholder="" class="form-control" maxlength = "15" <?php if($acao == 'ver' or $acao == 'apaga'): ?>readonly=""<?php endif; ?> required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input id="qtpeca" name="qtpeca" value="<?php echo $produto["qtprod"]; ?>" type="text" placeholder="" class="form-control" maxlength = "15" <?php if($acao == 'ver' or $acao == 'apaga'): ?>readonly=""<?php endif; ?> required>
                                                </div>
                                            </div>                                        
                                    </div>
                                <br>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Gerenciador Financeiro'},
                    {extend: 'pdf', title: 'Gerenciador Financeiro'},
