                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <button type="button" class="btn btn-warning btn-lg btn-block"><i
                                                        class="fa fa-edit"></i> Vendas
                            </button>
                        </div>

                        <div class="ibox-content">
                            <div class="pull-left">
                                <a onclick="#" href="vandaacoes.php?acao=nova" class="btn btn-warning ">Incluir</a>
                            </div>
                            <br>
                            <br>
                            <br>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php foreach($vendas as $venda): ?>
                                            <tr class="gradeX">
                                                <?php $datap = strtotime($venda["dtvenda"]) ;?>
                                                <?php $coluna1 = trim($venda["cdvenda"]); ?>
                                                <?php $coluna2 = date("d/m/Y",$datap); ?>
                                                <?php $coluna3 = trim($venda["cdclie"]); ?>
                                                <?php $coluna4 = "R$ ".number_format($venda["vlvenda"],2,',','.'); ?>
                                                <?php $coluna5 = trim($venda['cdsitu']); ?>

                                               
                                                <?php $ver = "vandaacoes.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $edita = "vandaacoes.php?acao=edita&chave=".$coluna1; ?>
                                                <?php $apaga = "vandaacoes.php?acao=apaga&chave=".$coluna1; ?>
                                                <?php $imprime = "vendaprint.php?acao=imprime&chave=".$coluna1; ?>
